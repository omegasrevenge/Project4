...
namespace GooglePlayGames.Android {
    public class AndroidClient : IPlayGamesClient {
        ...
        string mUserId = null, mUserDisplayName = null, mAccountName = null, mToken = null;
        ...
        private void RetrieveUserInfo() {
            ...
            {
                mAccountName = mGHManager.CallGmsApi<string>("games.Games", null, "getCurrentAccountName");
                Logger.d("Player account name: " + mAccountName);
            }
            ...
            if (mToken == null)
            {
                ...
                //Logger.d("Player account name: " + mToken);
            }
        }
        ...
        public string GetToken()
        {
            ...
            {
                AndroidJavaClass GoogleAuthPlugin = new AndroidJavaClass("de.mediadesign.gd1011.project4.GoogleAuthPlugin");
                mToken = GoogleAuthPlugin.CallStatic<string>("getToken");
                if(!string.IsNullOrEmpty(mToken))
                    Logger.d("Token: " + mToken);
            }
        ...
        {
            AndroidJavaClass GoogleAuthPlugin = new AndroidJavaClass("de.mediadesign.gd1011.project4.GoogleAuthPlugin");
            return GoogleAuthPlugin.CallStatic<string>("getError");
        }
