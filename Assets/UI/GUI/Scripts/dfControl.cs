...
public abstract class dfControl : MonoBehaviour, IDFControlHost, IComparable<dfControl>
{
	...
	/// </summary>
	public bool GetHitPosition( Ray ray, out Vector2 position, bool clamp = true )
	{
	...
	public Rect GetScreenRect()
	{
		...
		var screenUL = camera.WorldToScreenPoint( corners[ 0 ] ).RoundToInt();
		var screenBR = camera.WorldToScreenPoint( corners[ 3 ] ).CeilToInt();
