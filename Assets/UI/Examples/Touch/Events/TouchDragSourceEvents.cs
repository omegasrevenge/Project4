...
public class TouchDragSourceEvents : MonoBehaviour
{
	...
	//public void OnDragEnter( dfControl control, dfDragEventArgs dragEvent )
	//{
	//    _label.Text = "Drag Enter: " + dragEvent.Source;
	//}

	//public void OnDragLeave( dfControl control, dfDragEventArgs dragEvent )
	//{
	//    _label.Text = "Drag Leave: " + dragEvent.Source;
	//}
