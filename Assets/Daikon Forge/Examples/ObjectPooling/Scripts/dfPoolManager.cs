...
#pragma warning restore 0168
	...
	private IEnumerator preloadPools()
	{
		...
		var totalItems = objectPools.Sum( p => p.InitialPoolSize );
	...
	public class ObjectPool
	{
		...
		public GameObject Spawn( Vector3 position, Quaternion rotation, bool activate = true )
		{
		...
		public GameObject Spawn( bool activate = true )
		{
		...
		internal void Preload( Action callback = null )
		{
