...
public abstract class dfTweenComponent<T> : dfTweenComponentBase
{
	...
	protected internal IEnumerator Execute( dfObservableProperty property )
	{
		...
		while( true )
		{
			...
			property.Value = evaluate( actualStartValue, actualEndValue, time );
