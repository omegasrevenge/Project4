...
public class BattleSounds : MonoBehaviour
{
    ...
    //public const string DriodDeselect = "SFX/Oc_Audio_SFX_Fight_Driode_Deselect";
    public const string DriodBreak = "SFX/Oc_Audio_SFX_Fight_Driode_Break";

    public const string BackgroundVengea = "Music/Music_Vengea_Fight";
    ...
    public const string WolfAttack3 = "SFX/Oc_Audio_SFX_Fight_Wolf_Attack_Basic_2";
    public const string WolfAttack4 = "SFX/Oc_Audio_SFX_Fight_Wolf_Attack_Special_2";

    public const string WolfIdle = "SFX/Oc_Audio_SFX_Fight_Wolf_Idle";

    public const string GiantAttack1 = "SFX/Oc_Audio_SFX_Fight_Giant_Attack_Special_1";
    public const string GiantAttack2 = "SFX/Oc_Audio_SFX_Fight_Giant_Attack_Basic_1";
    public const string GiantAttack3 = "SFX/Oc_Audio_SFX_Fight_Giant_Attack_Basic_2";
    public const string GiantAttack4 = "SFX/Oc_Audio_SFX_Fight_Giant_Attack_Special_2";
