...
public class NerdGPG : MonoBehaviour
{
    ...
    public const string appID = "1002351733701";
    public const string serverID = "1002351733701-ppn9cqsqmd31mjrnd02v80bob7c43m10.apps.googleusercontent.com";
    ...
    {
        return mNerdGPG.Call<string>("getAccessToken", serverID);
    }
    ...
    public void OnGPGSubmitScoreResult(bool result)
    {
        if (CBSubmitScore != null)
            CBSubmitScore(result);
    }
